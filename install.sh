...
docker-compose -T exec django bash -c "./manage.sh create_gem_user"
docker-compose -T exec django bash -c "./manage.sh add_user /usr/src/openquakeplatform/data_commands/auth_user.json"
docker-compose -T exec django bash -c "./manage.sh add_documents"
